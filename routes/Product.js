...
router.get('/add_product', async (req, res) => {
  ...
  console.log("vendorsssssssssssssssssssss",vendors)
  res.render('Product_add', { vendors,categories });
});
...
router.get('/edit/:id', async function(req, res, next){
    try {
        ...
        const categories = await Category.find({});
        const vendors = await Customer.find({isVendor: true});
        res.render('Product_edit', {product_array: db_product_array, categories,vendors });
    } catch (err) {
